...
<head>
    ...
    <!--CSS-->
    <link rel="stylesheet" href="{{ asset('grade.css') }}"> <!-- New CSS file for the container -->
</head>
<body>
    ...
    <div class="grade" style="position: fixed">Grade</div>
    ...
    <div class="info-container">
        ...
        <div class="container1">
            <button class="box" onclick="window.location.href='{{ route('grade-quiz-title') }}'">Quiz</button>
        </div>
