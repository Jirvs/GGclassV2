...
<head>
    ...
    <!--CSS-->
    <link rel="stylesheet" href="{{ asset('feedback.css') }}"> <!-- New CSS file for the container -->
</head>
<body>
    ...
    <div class="feedback" style="position: fixed">Feedback</div>
    ...
    <div class="info-container">
        ...
        <div class="container-buttons">
            ...
            <button class="btn  challenge-btn active">Feedback</button>
